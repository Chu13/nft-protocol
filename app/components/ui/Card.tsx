...
interface CardProps {
  ...
  elevated?: boolean;
  /** Stable test hook for tooling (e.g. screenshot capture) that needs to target a specific card. */
  "data-testid"?: string;
}

export function Card({ children, className = "", elevated = false, "data-testid": testId }: CardProps) {
  return (
    <div
      data-testid={testId}
